...
case 'android':
    switch (arch) {
    case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'port-selector.android-arm64.node'))
        try {
            if (localFileExisted) {
        ...
        break
    case 'arm':
        localFileExisted = existsSync(join(__dirname, 'port-selector.android-arm-eabi.node'))
        try {
            if (localFileExisted) {
...
case 'darwin':
    switch (arch) {
    case 'x64':
        localFileExisted = existsSync(join(__dirname, 'port-selector.darwin-x64.node'))
        try {
            if (localFileExisted) {
...
case 'freebsd':
    ...
    localFileExisted = existsSync(join(__dirname, 'port-selector.freebsd-x64.node'))
    try {
        if (localFileExisted) {
...
module.exports.isFreeUdp = isFreeUdp
module.exports.randomFreePort = randomFreePort
module.exports.randomFreeTcpPort = randomFreeTcpPort
module.exports.randomFreeUdpPort = randomFreeUdpPort
module.exports.selectFromGivenPort = selectFromGivenPort
module.exports.selectFreePort = selectFreePort
